const app = {
    ...
    const navbarHTML = `
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
          <a class="navbar-brand" href="${this.basePath()}/index.html">J & L</a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <div class="d-flex align-items-center">
              <a href="${this.basePath()}/views/checkout.html" class="nav-link p-0 position-relative">
                <div class="d-flex align-items-center gap-2">
                  ...
                  <div class="d-none d-xl-block">
                    <div class="small text-muted mb-0" style="font-size: 0.7rem; line-height: 1;">My Items</div>
                    <div class="fw-bold" style="font-size: 0.9rem;">Yellow Basket</div>
                  </div>
                </div>
              </a>
            </div>
  ...
  getProductCardHTML(product) {
    let stockHTML = product.stock > 0 ? 
      `<p class="small text-success mb-1">${product.stock} in stock</p>` : 
      `<p class="small text-danger mb-1">Out of Stock</p>`;
      
    // Truncate name
    let displayName = product.name.length > 25 ? product.name.substring(0, 22) + "..." : product.name;
          ...
          <a href="${this.basePath()}/views/product-details.html?id=${product.id}" class="text-decoration-none text-dark">
            ...
            <div class="product-info">
              ...
              <div class="d-flex justify-content-center align-items-center mb-1">
                ...
                <span class="product-price fw-bold">$${product.price.toFixed(2)}</span>
              </div>
              <p class="small text-muted mb-1">${product.brand}</p>
              ${stockHTML}
            </div>
          </a>
        </div>
